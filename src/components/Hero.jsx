...
<section id='home' className="relative h-screen carousel-container">
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white">
      ...
      <p className="text-xl md:text-2xl">Discover the perfect escape with our exclusive travel packages designed to make your dream vacation a reality</p>
...
<div className="relative h-screen">
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white">
      ...
      <p className="text-xl md:text-2xl">Embark on a journey of a lifetime with our curated tours, offering you a chance to explore  stunning destinations worldwide</p>
      <button className="mt-4 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 hover:scale-105 hover:border-black transition-colors">
                   Explore
                  </button>
    </div>
...
<div className="relative h-screen">
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white">
      ...
      <p className="text-xl md:text-2xl">From enchanting snowy landscapes to luxurious lodges and festive events, our tours promise a magical winter getaway for all</p>
      <button className="mt-4 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 hover:scale-105 hover:border-black transition-colors">
                   Explore
                  </button>
    </div>
